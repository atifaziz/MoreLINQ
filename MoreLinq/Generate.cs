...
namespace MoreLinq
{
    ...
    {
        /// <summary>
        /// Returns a sequence of values consecutively generated by an
        ...
        public static IAsyncEnumerable<TResult>
            GenerateAsync<TResult>(TResult initial,
                                   Func<TResult, Task<TResult>> generator) =>
            GenerateAsync(initial, (x, _) => generator(x));

        /// <summary>
        /// Returns a sequence of values consecutively generated by an
        /// asynchronous generator function supporting cancellation.
        /// </summary>
        /// <typeparam name="TResult">Type of elements to generate.</typeparam>
        /// <param name="initial">Value of first element in sequence</param>
        /// <param name="generator">
        ...
        public static IAsyncEnumerable<TResult>
            GenerateAsync<TResult>(TResult initial,
                                   Func<TResult, CancellationToken, Task<TResult>> generator) =>
            generator == null
            ? throw new ArgumentNullException(nameof(generator))
            : new GenerateAsyncEnumerable<TResult>(initial, generator);

        sealed class GenerateAsyncEnumerable<T> : IAsyncEnumerable<T>
        {
            readonly T _initial;
            readonly Func<T, CancellationToken, Task<T>> _generator;

            public GenerateAsyncEnumerable(T initial, Func<T, CancellationToken, Task<T>> generator)
            {
                _initial = initial;
            ...
            public async IAsyncEnumerator<T> GetAsyncEnumerator(CancellationToken cancellationToken)
            {
                ...
                {
                    yield return current;
                    current = await _generator(current, cancellationToken);
                }
            }
        }
    }
